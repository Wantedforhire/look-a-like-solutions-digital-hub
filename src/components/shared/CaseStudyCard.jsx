    ...
    <ScrollReveal delay={index * 0.06} className="h-full">
      ...
      >
        ...
        <div className="p-6 flex flex-col flex-1">
          ...
          <h3 className="text-base font-bold text-slate-900">{caseStudy.clientName}</h3>
          <p className="text-sm text-slate-500 mt-1">{caseStudy.industry} &middot; {caseStudy.service}</p>
        </div>
      </Link>
    </ScrollReveal>
  );
