...
const metrics = [
  ...
  { value: 10, suffix: "K+", label: "YouTube Subscribers Generated", color: "text-indigo-accent", staticText: "10K+" },
  { value: 8, suffix: "+", label: "Multi-Industry Campaign Experience", color: "text-emerald-accent" },
  { value: 0, suffix: "", label: "Cost Per Lead Reduced", color: "text-emerald-accent", staticText: "40-60%" }
];
            ...
            <ScrollReveal key={m.label} delay={i * 0.06}>
              <div className="glass-cell rounded-2xl p-7 h-full hover:shadow-md transition-shadow duration-300">
                <p className={`text-4xl font-extrabold tracking-tight ${m.color}`}>
                  {m.staticText || <AnimatedCounter value={m.value} suffix={m.suffix} />}
                </p>
